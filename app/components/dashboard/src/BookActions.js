...
const renderRename = (
  ...
  return canRenameBooks && <Action onClick={onClickRename}><Trans i18nKey="rename">Rename</Trans></Action>
}
...
const Actions = props => {
  ...
  const renderMainAction = () => {
    if (
      ...
      return <Action to={`/books/${id}/book-structure`}><Trans i18nKey="plan_book">Plan Book</Trans></Action>
    }

    return <Action to={`/books/${id}/book-builder`}><Trans i18nKey="edit">Edit</Trans></Action>
  }
