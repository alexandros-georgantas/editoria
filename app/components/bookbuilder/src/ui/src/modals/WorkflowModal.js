...
const WorkflowModal = props => {
  ...
  */
  const bodyMsg = {
    'cp-no': t(
      'copy_editors_won’t_be_able_to_edit_this_chapter_after_updating_this_workflow_status.',
    ),
    'cp-yes': t(
      'copy_editors_will_be_able_to_edit_this_chapter_after_updating_this_workflow_status.',
    ),
    'author-no': t(
      'authors_won’t_be_able_to_edit_this_chapter_after_updating_this_workflow_status.',
    ),
    'author-yes': t(
      'authors_will_be_able_to_edit_this_chapter_after_updating_this_workflow_status.',
    ),
    'cp-no-author-no': t(
      'copy_editors_and_authors_won’t_be_able_to_edit_this_chapter_after_updating_this_workflow_status.',
    ),
    'cp-no-author-yes': t(
      'copy_editors_won’t_be_able_to_edit_but_authors_will_be_able_to_edit_this_chapter_after_updating_this_workflow_status.',
    ),
    'cp-yes-author-no': t(
      'copy_editors_will_be_able_to_edit_but_authors_won’t_be_able_to_edit_this_chapter_after_updating_this_workflow_status.',
    ),
  }
  ...
  return (
    <DialogModal
      buttonLabel="Yes"
      headerText={t('Change of workflow status')}
      isOpen={isOpen}
      onConfirm={onConfirm}
